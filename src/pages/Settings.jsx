                  ...
                  <div className="space-y-6">
                    <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                      <div className="flex items-start gap-3">
                        <Lock className="text-accent mt-1" size={20} />
                        <div>
                          ...
                          <button 
                            ...
                            className="mt-3 px-4 py-2 bg-white text-accent border border-accent/20 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors"
                          >
                            Change Password
                          </button>
                        </div>
