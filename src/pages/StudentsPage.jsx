...
const StudentsPage = ({ onLogout }) => {
  ...
  React.useEffect(() => {
    const fetchPendingRequests = async () => {
      try {
        const response = await fetch('http://localhost:3001/api/student-requests');
        const result = await response.json();
        if (result.success) {
        ...
        <main className="flex-1 overflow-y-auto p-8 themed-bg">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <button onClick={() => setShowAddModal(true)} className="bg-blue-600 text-white px-4 py-2.5 rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center gap-2">
                  <User size={18} />
                  Add Student
                </button>
                <select
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <button 
                              ...
                              className="p-1.5 text-accent hover:bg-gray-50 rounded-lg transition-colors"
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <span className="inline-block px-2 py-1 rounded-full text-xs font-semibold mt-1 bg-gray-100 text-accent">
