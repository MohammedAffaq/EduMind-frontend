...
export default function Login({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // Store token, refresh token and user in localStorage.currentUser
        const merged = { token: result.token, refreshToken: result.refreshToken, ...result.user };
        ...
        alert(`Welcome back, ${result.user.firstName} ${result.user.lastName}! You have successfully logged in.`);
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              {isLoading ? (
                ...
                `Login as ${roles.find(r => r.value === formData.role)?.label || 'Student'}`
              )}
            </button>
          </form>
